// ─── Estimation module Overview — main Side Nav entry (S23 nav correction) ─
        ...
        <div className="flex flex-col flex-1 min-h-0 min-w-0">
          <main className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <p className="text-[14px] text-[var(--hz-ink-muted)] m-0 mt-1 max-w-xl" style={{ fontFamily: FONT_BODY }}>
              Structure project inputs, open estimates, and use tools like the Material Calculator. Upload Plan and Price Book arrive in later slices.
            </p>
            ...
            {projectId && (
              <section className="mt-6 rounded-[16px] border border-[var(--hz-border)] bg-[var(--hz-surface)] p-5 max-w-2xl">
                ...
                <p className="text-[14px] text-[var(--hz-ink-muted)] m-0 mt-2" style={{ fontFamily: FONT_BODY }}>
                  Continue with the AI Estimation Advisor or open project estimates. No fabricated totals.
                </p>
