...
const TEXT_ACTION = `inline-flex items-center min-h-[44px] cursor-pointer border-0 bg-transparent p-0 rounded-[6px] text-[13px] font-semibold text-[#722ED1] ${FOCUS_RING}`
const PRIMARY_BTN = `h-11 px-5 rounded-[12px] text-[13.5px] font-semibold cursor-pointer border-0 min-h-[44px] ${FOCUS_RING}`
...
export default function ProjectOverviewScreen({
  ...
  }, [audience, projectId, serverProject])
  ...
  if (audience === 'invited') {
    return (
      <OverviewChrome isCompanyUser={false} projectId={undefined} subNavVariant="customer" onNavigate={onNavigate}>
        <main className="flex-1 flex flex-col items-center justify-center gap-4 px-6 min-w-0">
          <HIcon size={36} />
