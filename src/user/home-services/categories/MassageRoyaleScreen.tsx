// ─── Massage Royale — Men's Salon & Massage → Massage for Men → Royale ────
//
// Built from a real-page reference PDF the user supplied (UB08) — used
// for its "Select a service" catalogue (5 sections: Pain relief, Stress
// relief, Sports therapy, Signature therapy, Add-ons) and every
...
// never invented — simply omitted (e.g. Hot bed has no duration in the
// reference, so none is shown here). A "Save more: Add pack of 4…"
// line under several items is a real bundle upsell the reference
// shows, kept as a plain note rather than built into a bespoke packs
// feature this page doesn't otherwise have.
//
...
// Hozie shell. Two items ("Deep tissue healing therapy", "Sublime
// Swedish massage") carry a green "BESTSELLER" tag in the reference —
// shown here with the same gold "★ Bestseller" pill Salon Royale/Prime
// already use, for one consistent badge language across the app rather
// than a third one-off style.
//
...
const IcoSparkle = () => (
  <svg width="22" height="22" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M10 2.5c.6 3 2 4.4 5 5-3 .6-4.4 2-5 5-.6-3-2-4.4-5-5 3-.6 4.4-2 5-5Z" />
    <path d="M16 14c.3 1.3.9 1.9 2.2 2.2-1.3.3-1.9.9-2.2 2.2-.3-1.3-.9-1.9-2.2-2.2 1.3-.3 1.9-.9 2.2-2.2Z" />
  </svg>
)
const IcoPlus = () => (
  <svg width="22" height="22" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
interface MassageItem {
  id: string
  title: string
  section: 'pain-relief' | 'stress-relief' | 'sports-therapy' | 'signature-therapy' | 'add-ons'
  bestseller?: boolean
  rating: string
  price: number
...
const MASSAGE_ITEMS: MassageItem[] = [
  // ── Pain relief ──
  { id: 'mr-deep-tissue-healing', title: 'Deep tissue healing therapy', section: 'pain-relief', bestseller: true, rating: '4.88 (56K reviews)', price: 1869, priceLabel: 'starts-at', durationMin: 60, description: 'Revitalises muscles & tissues with Lomi-Lomi technique to ease stiffness', note: 'Save more: Add pack of 4 to unlock ₹1,419/ massage', icon: <IcoHands /> },
  { id: 'mr-deep-tissue-head-neck-shoulder-foot', title: 'Deep tissue with head, neck, shoulder & foot reflexology', section: 'pain-relief', rating: '4.85 (4K reviews)', price: 3197, originalPrice: 3347, durationMin: 110, description: '60 mins deep tissue massage & 50 mins head/neck/shoulder/foot massage', icon: <IcoHands /> },

  // ── Stress relief ──
  { id: 'mr-sublime-swedish', title: 'Sublime Swedish massage', section: 'stress-relief', bestseller: true, rating: '4.87 (33K reviews)', price: 1619, priceLabel: 'starts-at', durationMin: 60, description: 'Restores balance, enhancing health & wellness', note: 'Save more: Add pack of 4 to unlock ₹1,219/ massage', icon: <IcoLeaf /> },
  { id: 'mr-abhyanga-therapy', title: 'Abhyanga therapy', section: 'stress-relief', rating: '4.85 (3K reviews)', price: 2019, durationMin: 60, description: 'Ayurvedic medium-pressure massage with Vedic techniques', icon: <IcoLeaf /> },

  // ── Sports therapy ──
  { id: 'mr-sports-post-workout', title: 'Sports & post work-out therapy', section: 'sports-therapy', rating: '4.89 (16K reviews)', price: 2069, priceLabel: 'starts-at', durationMin: 60, description: 'Eases stiffness & promotes relaxation for tired muscles', note: 'Save more: Add pack of 4 to unlock ₹1,569/ massage', icon: <IcoSports /> },

  // ── Signature therapy ──
  { id: 'mr-wellness-retreat', title: 'Wellness retreat therapy', section: 'signature-therapy', rating: '4.87 (9K reviews)', price: 2219, durationMin: 90, description: 'Signature strokes blend five unique massage techniques', icon: <IcoSparkle /> },
  { id: 'mr-balinese-therapy', title: 'Balinese therapy', section: 'signature-therapy', rating: '4.87 (3K reviews)', price: 1919, durationMin: 60, description: 'Uses specialised techniques for a deeply relaxing experience', note: 'Ideal for those with muscle tightness & discomfort', icon: <IcoSparkle /> },
  { id: 'mr-hot-stone-therapy', title: 'Hot stone therapy', section: 'signature-therapy', rating: '4.88 (1K reviews)', price: 1919, durationMin: 60, description: 'Full-body massage with heated stones to ease tense muscles', note: 'Eases tightness, increases flexibility & helps you unwind', icon: <IcoSparkle /> },
  { id: 'mr-thai-massage', title: 'Thai massage', section: 'signature-therapy', rating: '4.90 (6K reviews)', price: 1499, priceLabel: 'starts-at', durationMin: 60, description: 'Customized oil-free dry stretch targeting pressure points', note: 'Save more: Add pack of 4 to unlock ₹300 off per massage', icon: <IcoSparkle /> },
  { id: 'mr-sleep-therapy', title: 'Sleep therapy', section: 'signature-therapy', rating: '4.86 (5K reviews)', price: 1719, priceLabel: 'starts-at', durationMin: 60, description: 'Full-body ritual for calming sleep and relaxed muscles', note: 'Save more: Add pack of 4 to unlock ₹1,369/ massage', icon: <IcoSparkle /> },

  // ── Add-ons ──
  { id: 'mr-foot-reflexology', title: 'Foot reflexology', section: 'add-ons', rating: '4.88 (17K reviews)', price: 849, durationMin: 30, description: 'Soothes tired feet, aids digestion & balances energy', icon: <IcoPlus /> },
  { id: 'mr-head-neck-shoulder-massage', title: 'Head, neck & shoulder massage', section: 'add-ons', rating: '4.89 (14K reviews)', price: 649, durationMin: 20, description: 'Recommended for exhaustion, busy schedules & bad posture', icon: <IcoPlus /> },
  { id: 'mr-head-massage', title: 'Head massage', section: 'add-ons', rating: '4.93 (6K reviews)', price: 569, durationMin: 20, description: 'Gentle massage releases muscle tension & improves skin clarity', icon: <IcoPlus /> },
  { id: 'mr-stretch-therapy', title: 'Stretch Therapy', section: 'add-ons', rating: '4.93 (4K reviews)', price: 549, durationMin: 15, icon: <IcoPlus /> },
  { id: 'mr-massage-topup-15', title: 'Massage top-up (15 mins)', section: 'add-ons', rating: '4.90 (4K reviews)', price: 225, durationMin: 15, description: 'Extend your relaxation with 15 extra minutes of massage therapy', icon: <IcoPlus /> },
  { id: 'mr-hot-bed', title: 'Hot bed', section: 'add-ons', rating: '4.88 (4K reviews)', price: 49, description: 'Advanced technology for ambient massage temperature', note: 'Enhances relaxation & eases stiffness', icon: <IcoPlus /> },
]
...
const SECTIONS: { id: MassageItem['section']; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'sports-therapy', label: 'Sports therapy', icon: <IcoSports /> },
  { id: 'signature-therapy', label: 'Signature therapy', icon: <IcoSparkle /> },
...
const SECTION_BANNERS: Record<MassageItem['section'], { title: string; subtitle: string }> = {
  'pain-relief': { title: 'Ease chronic pain', subtitle: 'Deep tissue therapies to relieve tension and stiffness.' },
  'stress-relief': { title: 'Unwind, completely', subtitle: 'Calming massages to restore balance and ease your mind.' },
  'sports-therapy': { title: 'Recover like a pro', subtitle: 'Targeted therapy for post-workout recovery and flexibility.' },
  'signature-therapy': { title: 'Our finest rituals', subtitle: 'Curated signature treatments blending multiple techniques.' },
  'add-ons': { title: 'Make it yours', subtitle: 'Extend or enhance any massage with these add-ons.' },
}

function getMassageItem(id: string): MassageItem {
  const item = MASSAGE_ITEMS.find(i => i.id === id)
  if (!item) throw new Error(`Unknown Massage item id: ${id}`)
  return item
}
  ...
  return (
    <div className="flex md:hidden h-14 items-center justify-between px-4 bg-[var(--hz-surface)] border-b border-[var(--hz-border)] shrink-0 z-10">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[16px] font-semibold text-[var(--hz-ink)]" style={{ fontFamily: FONT_HEAD }}>Massage Royale</span>
      </div>
  ...
  return (
    <header className="hidden md:flex h-[64px] shrink-0 items-center justify-between px-6 lg:px-8 bg-[var(--hz-surface)] border-b border-[var(--hz-border)]">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-[20px] font-semibold text-[var(--hz-ink)] m-0" style={{ fontFamily: FONT_HEAD }}>Massage Royale</h1>
      </div>
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={() => onNavigate('booking-details', { hoziehelper_checkout_origin: 'massage-royale' })}
  ...
  return (
    ...
    >
      <div className="relative flex flex-col gap-4 px-5 sm:px-10 lg:px-12 py-8 sm:py-10">
        <span className="text-[11px] tracking-[0.12em] uppercase text-[var(--hz-primary)] font-semibold" style={{ fontFamily: FONT_MONO }}>Massage Royale</span>
        <h2 className="text-[22px] sm:text-[30px] lg:text-[34px] font-semibold text-[var(--hz-ink)] leading-[1.15] tracking-[-0.01em] m-0 max-w-[70%] sm:max-w-[420px]" style={{ fontFamily: '"Geist Variable", sans-serif' }}>
          Curated therapies,<br />top-rated hands.
        </h2>
        <p className="text-[13px] sm:text-[14.5px] text-[var(--hz-ink-muted)] leading-[1.5] m-0 max-w-[70%] sm:max-w-[380px]" style={{ fontFamily: FONT_BODY }}>
          Only highly-rated therapists and premium oils, at home.
        </p>
...
export default function MassageRoyaleScreen({
  onNavigate,
}: {
  ...
  const jumpToSection = (id: string) => {
    document.getElementById(`massage-royale-section-${id}`)?.scrollIntoView({ behavior: 'smooth', block: 'start' })
  }
  ...
  const viewCart = () => {
    onNavigate('booking-details', {
      hoziehelper_checkout_origin: 'massage-royale',
    })
  }
  ...
  return (
    <div className="flex flex-col relative" style={{ height: '100%', backgroundColor: 'var(--hz-surface)' }}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 items-start">
                ...
                <div className="flex flex-col gap-6 min-w-0">
                  ...
                  {SECTIONS.map(section => {
                    ...
                    return (
                      <div key={section.id} id={`massage-royale-section-${section.id}`} className="flex flex-col gap-3" style={{ scrollMarginTop: 230 }}>
      ...
      {detailItemId && (
        <ServiceDetailModal
          item={getMassageItem(detailItemId)}
          cartCount={cartCountForItem(detailItemId)}
          onAdd={() => addToCart(getMassageItem(detailItemId))}
