  ...
  return (
    <div className="flex md:hidden h-14 items-center justify-between px-4 bg-[var(--hz-surface)] border-b border-[var(--hz-border)] shrink-0 z-10">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[16px] font-semibold text-[var(--hz-ink)]" style={{ fontFamily: FONT_HEAD }}>Ants &amp; Bed Bugs Control</span>
      </div>
  ...
  return (
    <header className="hidden md:flex h-[64px] shrink-0 items-center justify-between px-6 lg:px-8 bg-[var(--hz-surface)] border-b border-[var(--hz-border)]">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-[20px] font-semibold text-[var(--hz-ink)] m-0" style={{ fontFamily: FONT_HEAD }}>Ants &amp; Bed Bugs Control</h1>
      </div>
      <div className="flex items-center gap-2">
  ...
  return (
    ...
    >
      <div className="relative flex flex-col gap-4 px-5 sm:px-10 lg:px-12 py-8 sm:py-10">
        <span className="text-[11px] tracking-[0.12em] uppercase text-[var(--hz-primary)] font-semibold" style={{ fontFamily: FONT_MONO }}>Ants &amp; Bed Bugs Control</span>
              ...
              <div key={opt.id} className="flex items-center gap-3 rounded-[12px] p-3" style={CARD_SURFACE}>
                ...
                <div className="flex-1 min-w-0 flex flex-col gap-1">
                  ...
                  {opt.rating ? (
                    ...
                    <span className="flex items-center gap-1 text-[11px] font-semibold text-[var(--hz-ink-muted)]" style={{ fontFamily: FONT_HEAD }}><IcoClock /> {opt.duration}</span>
                  ) : null}
