...
const CLEANING_ITEMS: CleaningItem[] = [
  // ── Value deals ──
  { id: 'bc-intense-2bath', title: 'Intense cleaning (2 bathroom)', section: 'value-deals', cornerBadge: { label: '2 BATHROOMS', color: 'var(--hz-ink)' }, rating: '4.80 (7M reviews)', price: 978, originalPrice: 1058, durationMin: 120, description: 'Floor & tile cleaning with a scrub machine', note: '₹489 per bathroom', icon: <IcoScrubMachine /> },
  { id: 'bc-intense-3bath', title: 'Intense cleaning (3 bathroom)', section: 'value-deals', cornerBadge: { label: '3 BATHROOMS', color: 'var(--hz-ink)' }, rating: '4.80 (7M reviews)', price: 1437, originalPrice: 1587, durationMin: 180, description: 'Floor & tile cleaning with a scrub machine', note: '₹479 per bathroom', icon: <IcoScrubMachine /> },
  ...
  return (
    <div className="flex md:hidden h-14 items-center justify-between px-4 bg-[var(--hz-surface)] border-b border-[var(--hz-border)] shrink-0 z-10">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[16px] font-semibold text-[var(--hz-ink)]" style={{ fontFamily: FONT_HEAD }}>Bathroom Cleaning</span>
      </div>
  ...
  return (
    <header className="hidden md:flex h-[64px] shrink-0 items-center justify-between px-6 lg:px-8 bg-[var(--hz-surface)] border-b border-[var(--hz-border)]">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-[20px] font-semibold text-[var(--hz-ink)] m-0" style={{ fontFamily: FONT_HEAD }}>Bathroom Cleaning</h1>
      </div>
      <div className="flex items-center gap-2">
  ...
  return (
    <div className="bg-[var(--hz-surface)]/70 backdrop-blur-md border border-[var(--hz-border)] rounded-[16px] p-4 flex flex-col gap-3 sticky top-0 z-10" style={{ boxShadow: '0 1px 8px rgba(0,0,0,0.04)' }}>
      ...
      <div className="flex gap-3 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
        ...
        >
          <div className="w-14 h-14 rounded-[12px] overflow-hidden border border-[var(--hz-border)] flex items-center justify-center bg-[var(--hz-primary-wash)] text-[var(--hz-primary)] shrink-0"><IcoToiletBrush /></div>
          <span className="text-[12px] text-[var(--hz-ink)] text-center leading-tight" style={{ fontFamily: FONT_BODY }}>3-visit packs</span>
        </button>
        {SECTIONS.map(s => (
          <button
            key={s.id}
  ...
  return (
    ...
    >
      <div className="relative flex flex-col gap-4 px-5 sm:px-10 lg:px-12 py-8 sm:py-10">
        <span className="text-[11px] tracking-[0.12em] uppercase text-[var(--hz-primary)] font-semibold" style={{ fontFamily: FONT_MONO }}>Bathroom Cleaning</span>
    ...
    <div className="flex flex-col sm:flex-row items-stretch gap-4 sm:gap-5 rounded-[12px] p-4" style={CARD_SURFACE}>
      ...
      <div className="flex-1 min-w-0 flex flex-col sm:flex-row gap-4">
        <div className="flex-1 min-w-0 flex flex-col gap-1.5">
          ...
          <span className="text-[13px] text-[var(--hz-ink-muted)] leading-snug" style={{ fontFamily: FONT_BODY }}>{pkg.itemTitle}</span>
          ...
          {selectedOptions.length > 0 ? (
            ...
            <span className="text-[11px] text-[var(--hz-ink-subtle)] mt-0.5" style={{ fontFamily: FONT_BODY }}>{pkg.options.length} options available</span>
          )}
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 items-start">
                ...
                <div className="flex flex-col gap-6 min-w-0">
                  ...
                  <div id="bathroom-cleaning-section-packs" className="flex flex-col gap-3" style={{ scrollMarginTop: 230 }}>
                    <h2 className="text-[19px] font-semibold text-[var(--hz-ink)] m-0" style={{ fontFamily: FONT_HEAD }}>3-visit packs</h2>
