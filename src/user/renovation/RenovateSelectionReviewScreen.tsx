          ...
          <main className="flex-1 overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
            <div className="max-w-[720px] mx-auto px-5 sm:px-8 lg:px-10 pt-8 pb-12 flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h2 className="text-[24px] sm:text-[28px] font-semibold text-[#242326] m-0" style={{ fontFamily: FONT_HEAD }}>Review Your Selection</h2>
              </div>
              ...
              <SectionCard title="Scope">
                <p className="text-[13.5px] text-[#242326] leading-[1.6] m-0" style={{ fontFamily: FONT_BODY }}>{scope}</p>
              </SectionCard>

              <SectionCard title="Materials">
                <p className="text-[13.5px] text-[#242326] leading-[1.6] m-0" style={{ fontFamily: FONT_BODY }}>{materials}</p>
              </SectionCard>

              <button
                onClick={handleContinue}
                className="h-[52px] px-6 rounded-[12px] text-[14px] font-semibold transition-all duration-150 border-0 w-full sm:w-auto sm:min-w-[260px] bg-[#722ED1] text-white cursor-pointer hover:brightness-90 active:scale-[0.99]"
