    ...
    return (
      <div className="min-h-full flex flex-col relative items-center justify-center gap-4 px-6" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          <HIcon size={36} />
          <p className="text-[15px] font-semibold text-[#242326] m-0" style={{ fontFamily: FONT_HEAD }}>Unable to award this contractor.</p>
          <button type="button" onClick={backToCompare} className={selectClass} style={{ backgroundColor: '#722ED1', color: 'white', fontFamily: FONT_BODY }}>
    ...
    return (
      <div className="min-h-full flex flex-col relative items-center justify-center gap-4 px-6" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="relative z-10 flex flex-col items-center gap-3 text-center max-w-[380px]">
          ...
          <p className="text-[16px] font-semibold text-[#242326] m-0" style={{ fontFamily: FONT_HEAD }}>Contractor already selected</p>
          <button type="button" onClick={viewProject} className={`mt-1 ${selectClass}`} style={{ backgroundColor: '#722ED1', color: 'white', fontFamily: FONT_BODY }}>
            View Project →
          </button>
        </div>
      </div>
    ...
    <div className="flex flex-col relative" style={{ height: '100%', backgroundColor: '#FFFFFF' }}>
      ...
      <header className="shrink-0 bg-white" style={{ borderBottom: '1px solid #F4F0EC' }}>
        <div className="flex items-center justify-between h-14 px-4 sm:px-6 lg:px-8">
          <button type="button" onClick={backToCompare} className="flex items-center gap-1.5 text-[13px] font-medium text-[#68636D] hover:text-[#242326] cursor-pointer border-0 bg-transparent p-0" style={{ fontFamily: FONT_BODY }}>
      ...
      <main className="flex-1 overflow-y-auto px-4 sm:px-6 py-8">
        <div className="max-w-[720px] mx-auto flex flex-col gap-6">
          <div>
            <h1 className="text-[22px] font-semibold text-[#242326] m-0" style={{ fontFamily: FONT_HEAD }}>Award Contractor</h1>
          ...
          <SectionCard>
            <p className="text-[11px] tracking-[0.06em] uppercase text-[#9A949D] m-0 mb-2" style={{ fontFamily: FONT_MONO }}>Your Selected Bid</p>
            <p className="text-[26px] font-semibold text-[#242326] m-0" style={{ fontFamily: FONT_HEAD }}>{formatBidAmount(bid!.amount)}</p>

            <div className="flex flex-wrap gap-6 mt-4 pt-4" style={{ borderTop: '1px solid #F4F0EC' }}>
              <div>
                <p className="text-[11px] tracking-[0.06em] uppercase text-[#9A949D] m-0" style={{ fontFamily: FONT_MONO }}>Duration</p>
            ...
            <div className="mt-4 pt-4" style={{ borderTop: '1px solid #F4F0EC' }}>
              <p className="text-[11px] tracking-[0.06em] uppercase text-[#9A949D] m-0 mb-1.5" style={{ fontFamily: FONT_MONO }}>Proposal</p>
              <p className="text-[13px] text-[#68636D] m-0 leading-[1.6]" style={{ fontFamily: FONT_BODY }}>{proposalPreview}</p>
              <button type="button" onClick={viewFullBid} className="mt-1.5 text-[12.5px] font-semibold text-[#722ED1] hover:underline cursor-pointer border-0 bg-transparent p-0" style={{ fontFamily: FONT_BODY }}>
                View Full Bid →
              </button>
            </div>
          </SectionCard>
          ...
          <div className="rounded-[16px] p-5" style={{ backgroundColor: '#FEF3C7', border: '1px solid #FCE7C2' }}>
            <p className="text-[13px] text-[#242326] m-0 leading-[1.6]" style={{ fontFamily: FONT_BODY }}>
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
            <button type="button" onClick={backToCompare} disabled={sending} className="h-11 px-5 rounded-[12px] text-[13.5px] font-semibold cursor-pointer bg-white" style={{ border: '1px solid #E3DDD7', color: '#68636D', fontFamily: FONT_BODY }}>
              Cancel
            </button>
            <button type="button" onClick={handleAward} disabled={sending} className="h-11 px-6 rounded-[12px] text-[13.5px] font-semibold text-white cursor-pointer border-0 disabled:opacity-60" style={{ backgroundColor: '#722ED1', fontFamily: FONT_BODY }}>
