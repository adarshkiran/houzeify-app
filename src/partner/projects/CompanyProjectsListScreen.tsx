...
function ProjectRow({ project, onClick }: { project: Project; onClick: () => void }) {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-between gap-3 rounded-[14px] bg-white p-4 text-left cursor-pointer min-h-[72px] hover:border-[#722ED1] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#722ED1]"
      style={{ border: '1px solid #E3DDD7', fontFamily: FONT_BODY }}
    >
      <div className="flex flex-col gap-1 min-w-0">
        <div className="flex items-center gap-2 flex-wrap min-w-0">
          <span className="text-[14.5px] font-semibold text-[#242326] break-words" style={{ fontFamily: FONT_HEAD }}>{project.name}</span>
          {typeLabel && (
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {project.location && (
            <span className="flex items-center gap-1 text-[12.5px] text-[#68636D] min-w-0">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <span className="text-[#9A949D]" aria-hidden="true"><IcoChevronRight /></span>
      </div>
    </button>
  )
}
  ...
  return (
    <div className="h-full flex" style={{ backgroundColor: '#FBF9F7' }}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="hidden md:flex h-[64px] shrink-0 items-center justify-between gap-3 px-6 lg:px-10 bg-white border-b border-[#E3DDD7]">
          <h1 className="text-[20px] font-semibold text-[#242326] m-0 truncate" style={{ fontFamily: FONT_HEAD }}>Projects</h1>
          ...
          <div className="max-w-[880px] mx-auto px-5 sm:px-8 lg:px-10 pt-8 pb-24 md:pb-12 flex flex-col gap-6">
            ...
            {!currentOrganization ? (
              ...
              <div className="flex flex-col items-center text-center gap-3 rounded-[16px] bg-white p-10" style={{ border: '1px solid #E3DDD7' }} aria-live="polite">
                <p className="text-[13px] text-[#68636D] m-0" style={{ fontFamily: FONT_BODY }}>Loading company projects…</p>
              </div>
            ) : status === 'error' ? (
